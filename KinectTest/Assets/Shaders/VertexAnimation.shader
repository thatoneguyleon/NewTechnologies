Shader "Anclin/Experiments/Vertex Animation"
{
	...
	fragmentInput vert(vertexInput i)
	{
		...
		// Waving mesh
		i.vertex.xyz += sin((i.vertex.y + _Time * _Speed) * _Value2) * _Value1;

		// Bubbling mesh
		i.vertex.xyz += i.normal * ( sin( (i.vertex.x + _Time * _Speed) * _Value2 ) + cos( (i.vertex.z + _Time * _Speed) * _Value2 )  ) * _Value1;
